...
export class DataSrcService implements InMemoryDbService {
  ...
  createDb(reqInfo?: RequestInfo) {
    const policies = this.policiesData();
    const nodes = this.graphNodes();
    const links = this.graphLinks();

    // default returnType
    let returnType  = 'object';     // 'observable';  'promise';
